...
public class CustomerCinema1View {
    ...
    public static ObservableList<MovieObject> getMovieObject(){
        File file = new File("C:\\Users\\Andreas\\Desktop\\proiect\\data\\Movies.json");
    ...
    public static ObservableList<TicketObject> getTicketObject(){
        File fileT = new File("C:\\Users\\Andreas\\Desktop\\proiect\\data\\CinemaAdmin1Tickets.json");
        ObjectMapper objectMapper=new ObjectMapper();
    ...
    public static Scene draw()
    {
        ...
        buyButton.setOnAction(e->{
            ...
            if(filmulet.getCantitateOcupata()>100)
            {
                ...
                File file = new File("C:\\Users\\Andreas\\Desktop\\proiect\\data\\CinemaAdmin1Tickets.json");
                ObjectMapper objectMapper = new ObjectMapper();
                try {
